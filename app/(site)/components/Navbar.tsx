...
export default function Navbar() {
  const navLinkClass =
    "text-[23px] leading-none font-medium text-[#171b2c] no-underline max-[1180px]:text-[18px]";
  ...
  return (
    <header className="flex w-full items-center justify-between gap-6 border-b border-[#dcdde1] bg-[#ececed] px-16 py-2.5 min-[1181px]:min-h-[72px] max-[1180px]:flex-wrap max-[1180px]:justify-center max-[1180px]:px-5 max-[1180px]:py-4">
      <Link
        className="leading-none font-bold tracking-[-0.02em] text-[#2dc2bd] text-[29px] max-[1180px]:text-[18px]"
        href="/"
      >
        CommandCtr
      </Link>
